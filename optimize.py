...
# -------------------------------------
gm_1 = gm_3 = gm_5 = l_1 = l_3 = l_5 = cdd_3 = cdd_5 = c_self = Itail = vds_0 = vds_1 = vsd_2 = it = vth_3 = 0
# -------------------------------------
...
def con_swing(TE, vth_3):  # swing
    return t_spec["vdd"] - t_spec["vcm"] - 2 / TE[2] - vth_3
...
def gm_id_optimizer(xk, final=False):
    ...
    Swing = (con_swing(xk, vth_3) + t_spec["swing"])[0]
    ...
    header = f"it,Gain,UGF,BW,Pole_2,Power,CMRR,SR,Swing,vds_0,vds_1,vds_2,vds_sat_0,vds_sat_1,vds_sat_2,TEs_0,TEs_1,TEs_2,Fins_0,Fins_1,Fins_2,I_s,I_tail"
    line = f"{it},{Gain},{UGF},{BW},{Pole_2},{Power},{CMRR},{SR},{Swing},{vds[0]},{vds[1]},{vds[2]},{vds_sat[0]},{vds_sat[1]},{vds_sat[2]},{TEs[0]},{TEs[1]},{TEs[2]},{Fins[0]},{Fins[1]},{Fins[2]},{I[0]},{I[1]}"
...
def my_brute_force():
        ...
        for te2 in np.linspace(bounds[1][0], bounds[1][1], 5):
            for te3 in np.linspace(bounds[2][0], bounds[2][1], 5):
                ...
                try:
                    ...
                    if (ch(con_gain(xk, l_3, l_5)) and ch(con_cmrr(xk, l_1, l_3, l_5)) and ch(
                            con_sr(xk, gm_3, c_self)) and
                            ch(con_p2(xk, gm_3, cgg_5)) and ch(con_vdsat0(xk, vds_0)) and ch(
                                con_vdsat1(xk, vds_1)) and ch(con_vdsat2(xk, vsd_2))):
                        min_power_true = p
    ...
    print(f"best_fins: {best_fins}")
    print(f"best_is: {best_is}")
    print(f"best_iter: {best_iter}")


def run_optimization():
    global gm_1, gm_3, gm_5, l_1, l_3, l_5, cdd_3, cdd_5, c_self, vds_0, vds_1, vsd_2, vth_3
    TE0 = [20, 15, 20]
    cons = (
