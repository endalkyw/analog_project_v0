...
from layout_gen.primitives.mos import *
            ...
            if pattern == 0: # Clustered --------------------- no diffusion break ---------------------------------------
                ...
                for pnt in points:
                    ...
                    for i in range(con[0]):
                        ...
                        rect_d1 = [[xi+ln1-lp["M1"]["width"]-2*C.m_m_ext+2*self.m1.stack*lp['M1']['pitch'], yi],[xi+ln1-lp["M1"]["width"]-2*C.m_m_ext+2*self.m1.stack*lp['M1']['pitch'] +ln1, yi + lp["M1"]["width"]]]
