...
class params:
    ...
    def get_mos_string(self,name,type,fins,nf,m,sd=[1,1],source_first=True):
        if source_first:
            ...
            self.p["d_name"] = name+":d"
            self.p["g_name"] = name+":g"
            self.p["s_name"] = name+":s"
            self.p["b_name"] = name+":b"
            ...
            return self.mos.format(**self.p) # inserting params


if __name__ == "__main__":
    p = params()
    str = p.get_mos_string("mn0","nfet",10,4,1)
    print(str)